...
<title><?php echo __SCHOOL_NAME__; ?> :: Admin Login</title>
...
<h2 class="text-center text-warning">ADMIN <h2>
...
<h1 class="mb-3">Glory Supreme Schools</h1>
...
<p class="text-center"><a href="https://glorysupremeschool.com">School Website</a></p></div>
</div>
</div>
</div>
</div>
