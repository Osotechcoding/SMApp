...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2022 at 12:12 AM
...
(1, 'Mathematics', NULL, NULL, 'active', 'MATH101', '2022-04-19'),
(2, 'English Language', NULL, NULL, 'active', 'ENG101', '2022-04-19'),
(3, 'Biology', NULL, NULL, 'active', 'BIO3392', '2022-04-19'),
(5, 'Agricultural Science', NULL, NULL, 'active', 'AGRSC203', '2022-04-19'),
(6, 'Economics', NULL, NULL, 'active', 'ECON0913', '2022-04-19'),
(10, 'Chemistry', NULL, NULL, 'active', 'CHEM908', '2022-05-10');
...
(3, 'BASIC I', 'A', 'none', NULL, 'active', '2022-04-20'),
(4, 'BASIC II', 'A', 'none', NULL, 'active', '2022-04-20'),
...
(1, '2020/2021', '1st Term', 46, 12, '2022-03-11', '2022-05-16', '2022-04-25');
...
(1, '2022/2023', '1st Term', 56, 14, '2022-07-29', '2022-09-05');
...
INSERT INTO `visap_staff_tbl` (`staffId`, `staffRegNo`, `staffGrade`, `staffRole`, `firstName`, `lastName`, `staffEmail`, `staffPass`, `staffUser`, `staffDob`, `staffEducation`, `staffPhone`, `staffCourse`, `staffAddress`, `confirmation_code`, `staffToken`, `tokenExpire`, `staffPassport`, `staffGender`, `maritalStatus`, `portalEmail`, `jobStatus`, `online`, `staffType`, `appliedDate`) VALUES
(1, 'GSSTA22-001', NULL, 'Principal', 'Samson Idowu', 'Agberayi', 'samson@gmail.com', '$2y$10$AE2ML.Q0b1kFIJjEE7rTcudhzui/en4pV8670WuZ7Ken/PCdW4vzq', 'samson', NULL, 'NCE', '08131374443', NULL, NULL, '2807aa0cc740236', NULL, NULL, NULL, 'Male', NULL, 'samson@gssota.portal', 1, 0, 'Teaching', '2022-05-16');
...
(1, 'GSS2022-0001', 'adeola@gmail.com', 'adeola', '$2y$10$zfVSuod1ShL6V6BSRg64R.hLBIvVL0intZSD4w5h/EZP/245lTKdq', 'BASIC I', 'Ademola', 'Adeola', 'Adewumi', '2016-09-07', 'Male', '31, Sango Ota, Ogun State', '08132127763', 'Active', '2022-05-11', 'Day', NULL, '4205143f5ef927', NULL, 0);
...
--
ALTER TABLE `visap_school_session_history_tbl`
  MODIFY `sehisId` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
