...
<ul class="dropdown-menu">
<li class="nav-item">
<a href="howtoapply" class="nav-link">How to Apply</a>
</li>
<li class="nav-item">
<a href="faq" class="nav-link"> Fee Structure</a>
</li>
<li class="nav-item">
<a href="javascript:void(0);" class="nav-link">School Anthem</a>
</li>
 <li class="nav-item">
<a href="academics" class="nav-link">Co-curicular Activities</a>
</li> 
<!--  <li class="nav-item">
...
<li class="nav-item">
<a href="ourprefects" class="nav-link">School Prefects</a>
</li>
<li class="nav-item">
...
<!-- <li class="nav-item">
<a href="e-result/" class="nav-link">Check Result</a>
</li> -->
 </ul>
</li>
<li class="nav-item">
