...
class Alert {
	...
	public function alert_toastr($type="warning",$msg="",$title=""){
      ...
      toastr.'.$type.'("'.$msg.'","'.$title.'",{closeButton:!0,extendedTimeOut:10000,tapToDismiss:!1,progressBar:!0,showMethod:"slideDown",hideMethod:"fadeOut",showDuration:500,timeOut:10000,hideDuration:500})
      </script>';
