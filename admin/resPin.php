...
<head>
    ...
    <title><?php echo __SCHOOL_NAME__ ?> ::  Student Result Checker</title>
        ...
        <div class="card-body card-dashboard">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped osotechExp table-hover">
              ...
              <tbody>
               <?php 
                $pin_datas = $_Pins_->get_pins("tbl_result_pins");
                 if ($pin_datas!="") {
                  $cnt =1;
               ...
               ?></td>
                  ...
                  <td><span class="badge badge-pill badge-danger badge-sm">Not Used</span></td>
                   <td><span class="badge badge-pill badge-success badge-sm">0</span></td>
                </tr>
                  <?php endforeach; ?>
               <?php } ?>
