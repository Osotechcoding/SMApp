             ...
             <div class="table-responsive">
                  <table class="table table-bordered table-striped text-center">
                        ...
                        <tr>
                            ...
                            <th width="10%"> C.Assessment</th>
                            <th width="10%"> TEST1(15)</th>
                            <th width="10%">TEST2(15)</th>
                            <th width="10%">EXAM(x/60)</th>
                            <th width="10%">Total(A+B+C)</th>
                            <th width="10%">AVERAGE(A+B+C/3)</th>
                        </tr>
                        </thead>
                  ...
                  <td><input type="text" value="<?php echo $value->test1;?>" class="form-control" readonly></td>
                  <td><input type="text" value="<?php echo $value->test2;?>" class="form-control" readonly></td>
                  ...
                  <td><input type="text" value="<?php echo number_format(($value->overallMark/3),2);?>" class="form-control" readonly></td>
