...
<div class="row">
             <div class="col-12">
    <h3 class="bd-lead text-primary text-bold"><span class="fa fa-cogs fa-1x"></span> Portal API Configuration </h3>
  </div>
    </div>
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <table  class="table table-striped table-bordered text-center osotechDatatable">
                                       ...
                                       <?php 
                                       $get_modules = $Configuration->get_configuration_modules_by_type("api");
                                       if ($get_modules) {
                                        $cnt=0;
                                        foreach ($get_modules as $modules) {
                                          ...
                                          <tr>
                                            ...
                                            <span class="badge badge-danger badge-md">Deactivated</span>
                                              <?php else: ?>
                                                <span class="badge badge-success badge-md">Enabled</span>
                                            <?php endif ?> 
                                            </td>
                                            <td>
                                            ...
                                            <?php endif ?>
                                              <?php else: ?>
                                                <?php if ($modules->module =='maintenance_mode'): ?>
                                                  <span class="btn btn-dark btn-sm enable_module" data-action="enable_module" data-id="<?php echo $modules->id; ?>">Deactivate</span> <i class="fa fa-reply-all" style="color: purple;width: 12px; height: auto;"></i>
                                              <?php else: ?>
                            ...
                            <button class="mb-4 mt-3 btn btn-success btn-round all-enable ml-2" data-action="enable_all" data-module="api" type="button" style="float: right;">
                            <i class="fa fa-key"></i> Enable All Modules</button>
                                    <button class="mb-4 mt-3 btn btn-danger btn-round all-disable" data-action="disable_all" data-module="api" type="button" style="float: right;"><i class="fa fa-lock"></i> Disable All Modules</button>
                                </div>
                          </div>
                        </div>
