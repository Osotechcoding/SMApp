...
<head>
    ...
    <title><?php echo __SCHOOL_NAME__; ?> :: View Student Attendant History</title>
            ...
            <div class="breadcrumbs-top">
              ...
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Students Attendant
                  </li>
                </ol>
              </div>
            </div>
...
<div class="row">
             <div class="col-12">
    <h3 class="bd-lead text-primary text-bold"><span class="fa fa-line-chart fa-2x"></span> Students Attendant Records </h3>
  </div>
    </div>
    <!-- content goes here -->
        <div class="card">
