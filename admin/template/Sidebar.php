        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
         ...
         <!--   <li class=" nav-item"><a href="javascript:void(0)"><i class="fa fa-edit fa-1x"></i><span class="menu-title text-truncate" data-i18n="Check Result">Check Result</span></a>
          ...
          <!-- student_attendance -->
           ...
           <li class="nav-item"><a href="view_student_attendance"><i class="fa fa-child fa-1x"></i><span class="menu-title text-truncate" data-i18n="Manage Prefects">View Attendance</span></a>
          </li>
