...
<head>
    ...
    <title><?php echo __SCHOOL_NAME__ ?> :: School Academic</title>
          ...
          <form class="form form-horizontal" id="update_academic_session_form">
            <div class="form-body">
              ...
              <div class="row">
                ...
                <button type="submit" class="btn btn-dark mr-1 __loadingBtn__">Update Session</button>
                  <a href="./"><button type="reset" class="btn btn-danger">Go Back</button></a>
                </div>
              </div>
            </div>
          </form>
