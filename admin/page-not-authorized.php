...
<head>
    ...
    <title>Not-authorized -  <?php echo __SCHOOL_NAME__ ?></title>
  ...
  <div class="col-xl-7 col-md-8 col-12">
    <div class="card bg-transparent shadow-none">
      <div class="card-body text-center bg-transparent">
        <img src="app-assets/images/pages/not-authorized.png" class="img-fluid" alt="not authorized" width="400">
        ...
        <a href="./" class="btn btn-primary round glow mt-2">BACK TO HOME</a>
      </div>
    </div>
  </div>
</section>
