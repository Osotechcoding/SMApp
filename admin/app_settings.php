                                        ...
                                        <div class="row">
                                         ...
                                         <input type="hidden" name="action" value="update_school_administrator">
                                            <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                <button type="submit" class="btn btn-primary glow mr-sm-1 mb-1 __loadingBtn13__">Save Changes</button>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="school_name" autocomplete="off" type="text" class="form-control"
                                                        placeholder="VISPA GROUP OF SCHOOLS" value="<?php echo ucwords($VisaPSchoolDetails->school_name)?>">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                 <div class="form-group">
                                                    ...
                                                    <input autocomplete="off" type="text" class="form-control" name="website_link"
                                                        placeholder="https://www.visapportal.com.ng" value="<?php echo $VisaPSchoolDetails->website_url?>">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <textarea name="student_home_address" id="home_address" class="form-control" placeholder="Student Permanent home address"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
