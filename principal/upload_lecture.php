...
<head>
    ...
    <title>VISAP - Virtual Classroom</title>
            ...
            <div class="col-md-3 dashboard-users-success">
              <div class="card text-center bg-info">
                <div class="card-body py-1">
                  ...
                  <h2 class="text-white mb-0"> <?php echo $Administration->count_all_available_lessons_today();?></h2>
                </div>
              </div>
            </div>
             <div class="col-md-3 dashboard-users-success">
       ...
       <div class="text-center" id="response"></div>
        <div class="table-responsive">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
              ...
              <a class="dropdown-item text-info" href="watch?type=<?php echo $values->file_type;?>&lessonId=<?php echo $values->lectureId;?>"> <?php if ($values->file_type==="video/mp4"): ?>
                <span class="fa fa-eye"></span>&nbsp;Watch
              <?php else: ?>
               <span class="fa fa-signal"></span>&nbsp; Listen
              <?php endif ?> </a>
              ...
              <div class="modal-content">
               ...
               <select name="std_grade" id="std_grade" class="select2 form-control">
                ...
                <select name="posted_by" id="posted_by" class="select2 form-control">
                 ...
                 <option value="1">Mr Samson O</option>
               </select>
                    </div>
                  </div>
                  <div class="col-md-6">
               ...
               <input type="date" class="form-control" name="expiry_date">
                ...
                <input type="text" autocomplete="off" class="form-control form-control-lg" name="topic" placeholder="Common Errors in English Language">
                   ...
                   <div class="col-md-12">
                     <div class="form-group">
                  <label for="lecture_mp4">LECTURE FILE <span class="text-danger">(Audio OR Video Files Only)</span></label>
                <input type="file" accept=".mp4,.mp3" class="form-control form-control-lg" name="myFile">
                    </div>
                  </div>
                 </div>
                  </div>
