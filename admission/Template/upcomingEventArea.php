...
<p><span><?php echo date("j");?></span> <?php echo date("M, Y");?></p>
</div>
</div>
...
<a href="events-details.php"><h3>Planning And Facilitating Effective</h3></a>
</div>
</div>
</div>
...
<p>Explore more. <a href="health-care.php" class="read-more-btn active">Click Me<i class="flaticon-next"></i></a></p>
</div>
</div>
</div>