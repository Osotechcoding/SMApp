...
<body>
  ...
  <!-- TopHeader -->
<div class="container" style="border: 2px solid darkblue;">
<aside class="right-side">                
              <!-- Content Header (Page header) -->
                ...
                <section class="content invoice">                    
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
                            <h2 class="page-header">
                                <img src="../assets/images/newlogo.png" width="120" alt="logo" style="border-radius:10px;border:3px solid darkblue;">
                                 Examination Photo Card.
                                <small class="pull-right">Date: <?php print date("l jS F, Y"); ?></small>
                            </h2>                            
                        </div><!-- /.col -->
                    </div>
                    <!-- info row -->
                    <div class="row invoice-info">
                        <div class="col-sm-6 col-md-6 col-lg-5 invoice-col">
                           <strong> School Details </strong>
                            <address>
                               <?php echo __SCHOOL_NAME__; ?><br>
								Address: 38, Oluwalogbon Gasline, Ijoko<br>
								State: Ogun State<br>
                   ...
                   ?>
                                             Your Used Card Pin: <b
                                            class="text-info"><?php  echo substr($card_details->pin_code, 0,5).'*****'.substr($card_details->pin_code, 10,5);?></b><br>
                                            Your Used Pin Serial : <b class="text-info"><?php  echo $card_details->pin_serial;?></b>
                              
                            </address>
                        </div><!-- /.col -->
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 invoice-col">
                        ...
                        <div class="col-lg-3 col-sm-3 col-md-3 invoice-col">
				...
				<tr>
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            <button class="btn btn-danger btn-md" onclick="window.print();"><i class="flaticon-blueprint"></i> Print</button>
                        </div>
                    </div>
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
