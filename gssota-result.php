...
<body>
  <section id="result">
    <img src="images/resulttop.png" alt="" class="schname">
    <!-- <hr> -->
   ...
   <?php if ($student_data->stdPassport==NULL || $student_data->stdPassport==""): ?>
      <img src="images/passportSample.jpg" alt="passport" style="float: right; width: 100px;height: 125px; margin-top: -150px; border: 4px solid #625D5D; padding: 2px;">
      <?php else: ?>
        <img src="portal/schoolImages/students/<?php echo $student_data->stdPassport;?>" alt="passport" style="float: right; width: 100px;height: 125px; margin-top: -150px; border: 4px solid #625D5D; padding: 2px;">
    <?php endif ?>
  ...
  <?php }
      ...
      <div class="footer-area">
        ...
        <div class="signarea">
          ...
          <br>
          <img src="images/signSample.png" alt="" style="margin-left:40px; margin-top: -5px; margin-right:auto; width: 50%;">
        </div>
      </div>
      <br>
<hr>
