...
<title><?php echo __SCHOOL_NAME__;?>:: Terms & Conditions</title>
</head>
<body>
...
<ul>
<li>
<a href="academics.php">Student<i class="ri-arrow-drop-right-fill"></i></a>
</li>
<li>
<a href="academics.php">Seminar<i class="ri-arrow-drop-right-fill"></i></a>
</li>
<li>
<a href="academics.php">Research<i class="ri-arrow-drop-right-fill"></i></a>
</li>
<li>
<a href="academics.php">Event<i class="ri-arrow-drop-right-fill"></i></a>
</li>
<li>
<a href="academics.php">Event<i class="ri-arrow-drop-right-fill"></i></a>
</li>
...
<a href="latest-news.php"><img src="assets/images/news/news-2.jpg" alt="Image"></a>
<h4><a href="latest-news.php">Professor Tom comments on the volunteer B. Snack brand</a></h4>
<p><i class="flaticon-tag"></i> Social Sciences</p>
</div>
</div>
<div class="related-post-box">
<div class="related-post-content">
<a href="latest-news.php"><img src="assets/images/news/news-3.jpg" alt="Image"></a>
<h4><a href="latest-news.php">Making a meaningful difference in patients’ lives.</a></h4>
<p><i class="flaticon-tag"></i> Social Sciences</p>
</div>
</div>
<div class="related-post-box">
<div class="related-post-content">
<a href="latest-news.php"><img src="assets/images/news/news-1.jpg" alt="Image"></a>
<h4><a href="latest-news.php">Happiness begins with good health</a></h4>
<p><i class="flaticon-tag"></i> Social Sciences</p>
</div>
</div>
</div>
