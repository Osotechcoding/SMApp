...
<div class="row">
             <div class="col-12">
    <h3 class="bd-lead text-primary text-bold"><span class="fa fa-cogs fa-1x"></span> Disable & Enable Portal User Login </h3>
  </div>
    </div>
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <table  class="table table-striped table-bordered text-center osotechDatatable">
                                       ...
                                       <?php 
                                       $get_modules = $Configuration->get_configuration_modules_by_type("login");
                                       if ($get_modules) {
                                        $cnt=0;
                                          ...
                                          <tr>
                                            ...
                                            <td><?php if ($modules->status=='1'): ?>
                                             <span class="badge badge-success badge-md">Enabled</span>
                                              <?php else: ?>
                                                <span class="badge badge-danger badge-md">Disabled</span>
                                            <?php endif ?> 
                                            </td>
                                            <td>
                            ...
                            <button class="mb-4 mt-3 btn btn-success btn-round all-enable ml-2" data-action="enable_all" data-module="login" type="button" style="float: right;">
                            <i class="fa fa-key"></i> Enable All </button>
                                    <button class="mb-4 mt-3 btn btn-danger btn-round all-disable" data-action="disable_all" data-module="login" type="button" style="float: right;"><i class="fa fa-lock"></i> Disable All</button>
                                </div>
                          </div>
                        </div>
   ...
   <script>
            ...
            //diable all module 
            $(document).on('click',".all-enable", function(){
