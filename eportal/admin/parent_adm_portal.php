...
<head>
    ...
    <title><?php echo __SCHOOL_NAME__ ?> ::  Parent Admission Portal</title>
    ...
    <div class="app-content content">
      ...
      <div class="content-wrapper">
             ...
             <h5 class="content-header-title float-left pr-1 mb-0"><?php echo __OSO_APP_NAME__; ?> PORTAL</h5>
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Parent Admission Portal
                  </li>
                </ol>
              </div>
            </div>
        ...
        <div class="content-body">
          <div class="row">
  <div class="col-12">
    <h3 class="bd-lead text-primary text-bold"><span class="fa fa-user-plus fa-2x"></span> PARENT ADMISSION PORTAL</h3>
  </div>
</div>
