...
<div class="row">
             <div class="col-12">
    <h3 class="bd-lead text-primary text-bold"><span class="fa fa-cogs fa-1x"></span> Disable & Enable Portal User Registration </h3>
  </div>
    </div>
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <table  class="table table-striped table-bordered text-center osotechDatatable">
                                       ...
                                       <?php 
                                       $get_modules = $Configuration->get_configuration_modules_by_type("registration");
                                       if ($get_modules) {
                                        $cnt=0;
                            ...
                            <button class="mb-4 mt-3 btn btn-success btn-round all-enable ml-2" data-action="enable_all" data-module="registration" type="button" style="float: right;">
                            <i class="fa fa-key"></i> Enable All Modules</button>
                                    <button class="mb-4 mt-3 btn btn-danger btn-round all-disable" data-action="disable_all" data-module="registration" type="button" style="float: right;"><i class="fa fa-lock"></i> Disable All Modules</button>
                                </div>
                          </div>
                        </div>
