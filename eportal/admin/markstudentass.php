    ...
    <div class="col-12">
      ...
      <table class="table table-striped table-bordered osotechDatatable">
        ...
        <tbody class="text-center">
          <?php 
      $all_submitted_ass = $Student->get_all_student_submitted_assignments_by_staffId($_SESSION['ADMIN_TOKEN_ID']);
      if ($all_submitted_ass) {
        ...
        <tr>
          ...
          <td> <?php if ($values->score !=NULL || $values->score > 0): ?>
         <span class="badge badge-primary badge-md"><?php echo $values->score;?></span>
          ...
          <td> <?php if ($values->status !=NULL || $values->status ==1): ?>
