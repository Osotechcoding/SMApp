    ...
    <td width="987" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tbody><tr>
        <td width="987" height="163" valign="top"><div>
          <form id="printresult" name="printresult" method="post" action="https://portal.glorysupremeschool.com/teacher/printresults3rdterm?mat_no=GSS/STD/0001&amp;session_code=2021/2022&amp;class_name=JSS%201">
