             ...
             <div class="table-responsive">
                    <table class="table table-stripped text-center">
                        ...
                        <tr>
                            ...
                            <th width="15%"> CA(10)</th>
                            <th width="15%"> TEST1(15)</th>
                            <th width="15%">TEST2(15)</th>
                            <th width="15%">EXAM(x/60)</th>
                        </tr>
                        </thead>
                    ...
                    <td><span><?php echo strtoupper($val->full_name);?></span> <input type="hidden" name="student_name[]" value="<?php echo strtoupper($val->full_name);?>"></td>
                    <td><span><?php echo strtoupper($get_all_exam_subjects->subject_name);?></span><input type="hidden" name="subject[]" value="<?php echo strtoupper($get_all_exam_subjects->subject_name);?>"></td>
                  <td><input type="number" placeholder="10" min="0" max="10" name="cass[]" step="1" class="form-control" required></td>
                  <td><input type="number" placeholder="15" min="0" max="15" name="test1[]" step="1" class="form-control" required></td>
                  <td><input type="number" placeholder="15" min="0" max="15" name="test2[]" step="1" class="form-control" required></td>
