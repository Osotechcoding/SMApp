                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="comment_class" id="comment_class" class="form-control">
                      <option value="<?php echo strtoupper($sess_Staffclass);?>" selected><?php echo strtoupper($sess_Staffclass);?></option>
                    </select>
                  </div>
                </div>
...
<div class="table-responsive">
        <table class=" table-bordered table table-stripped table-hover datatable">
                <thead class="text-center">
                    ...
                    <th width="15%">Overall Performance</th>
                    <th width="10%">Average Score</th>
                    <th width="40%">Class Teacher's Comment</th>
                </tr>
            </thead>
          ...
          <?php if ($student_result_data): ?>
            ...
            $obtaineable_mark = doubleval(14 * 100.00);
             ...
             <tr>
                  ...
                  <td><input type="text" name="comment[]"class="form-control" placeholder=" write comment here..."></td>
                </tr>
          <?php endif ?>
