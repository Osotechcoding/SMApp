...
<head>
    ...
    <title><?php echo __SCHOOL_NAME__; ?> :: Student Subject Registration</title>
            ...
            <?php if ($staff_data->staffGrade!="" || $staff_data->staffGrade !=NULL): ?>
              ...
              <div class="card text-center bg-dark">
                <div class="card-body py-1">
                  ...
                  <h2 class="text-white mb-0"><?php echo $Administration->count_all_registered_subjects_class($staff_data->staffGrade); ?></h2>
                </div>
              </div>
            </div>
            <?php endif ?>
