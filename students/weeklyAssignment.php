...
<div class="card">
<div class="card-body">
<h1 class="text-center mb-5 text-warning">SEARCH WEEKLY ASSIGNMENT.</h1>
<div class="row">
...
<button type="button" class="btn btn-outline-success btn-round btn-md">Submit Answer</button>
</td>
</tr>
</tbody>
</table>
